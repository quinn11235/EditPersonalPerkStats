...
- EditPersonalPerkStatsConfig.cs: Example of ModConfig for custom mod settings;
- EditPersonalPerkStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- EditPersonalPerkStatsMain.cs: Main mod class, recieves mod management and general events;
- EditPersonalPerkStatsTactical.cs: Example of ModTactical for modifying tactical level;
